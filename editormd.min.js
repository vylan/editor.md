...
e.children("textarea");1>k.length&&(e.append("<textarea></textarea>"),k=this.markdownTextarea=e.children("textarea"));k.addClass(h.textarea.markdown).attr("placeholder",b.placeholder);"undefined"!==typeof k.attr("name")&&""!==k.attr("name")||k.attr("name",""!==b.name?b.name:a+"-markdown-doc");a=[b.readOnly?"":'<a href="javascript:;" class="icon-close '+c+'preview-close-btn"></a>',b.saveHTMLToTextarea?'<textarea class="'+h.textarea.html+'" name="'+a+'-html-code"></textarea>':"",'<div class="'+c+'preview"><div class="markdown-body '+
c+'preview-container"></div></div>','<div class="'+c+'container-mask" style="display:block;"></div>','<div class="'+c+'mask"></div>'].join("\n");e.append(a).addClass(c+"vertical");""!==b.theme&&e.addClass(c+"theme-"+b.theme);this.mask=e.children("."+c+"mask");this.containerMask=e.children("."+c+"container-mask");""!==b.markdown&&k.val(b.markdown);""!==b.appendMarkdown&&k.val(k.val()+b.appendMarkdown);this.htmlTextarea=e.children("."+h.textarea.html);this.preview=e.children("."+c+"preview");this.previewContainer=
...
b.children("."+c+"toolbar"));if(!a.toolbar)return e.hide(),this;e.show();for(var b="function"===typeof a.toolbarIcons?a.toolbarIcons():"string"===typeof a.toolbarIcons?d.toolbarModes[a.toolbarIcons]:a.toolbarIcons,e=e.find("."+this.classPrefix+"menu"),c="",f=!1,k=0,l=b.length;k<l;k++){var g=b[k];if("||"===g)f=!0;else if("|"===g)c+='<li class="divider" unselectable="on">|</li>';else{var n=/h(\d)/.test(g),p=g;"watch"!==g||a.watch||(p="unwatch");var q=a.lang.toolbar[p],m=a.toolbarIconTexts[p],p=a.toolbarIconsClass[p],
...
"20px"),l.toolbar&&!l.readOnly?d.css("top",k.height()+1):d.css("top",0),!l.autoHeight||c.fullscreen||c.preview?(a=l.toolbar&&!l.readOnly?e.height()-k.height():e.height(),d.height(a)):d.height("")):(g.width(e.width()),d.hide());c.loaded&&f.proxy(l.onresize,this)();return this},save:function(){if(null===u)return this;var a=this,b=this.state,c=this.settings,e=this.cm,h=e.getValue(),k=this.previewContainer;if("gfm"!==c.mode&&"markdown"!==c.mode)return this.markdownTextarea.val(h),this;var l=d.$marked,
g=this.markdownToC=[],n=this.markedRendererOptions={toc:c.toc,tocm:c.tocm,tocStartLevel:c.tocStartLevel,pageBreak:c.pageBreak,taskList:c.taskList,emoji:c.emoji,tex:c.tex,atLink:c.atLink,emailLink:c.emailLink,flowChart:c.flowChart,sequenceDiagram:c.sequenceDiagram,previewCodeHighlight:c.previewCodeHighlight},n=this.markedOptions={renderer:d.markedRenderer(g,n),gfm:!0,tables:!0,breaks:!0,pedantic:!1,sanitize:c.htmlDecode?!1:!0,smartLists:!0,smartypants:!0};l.setOptions(n);l=d.$marked(h,n);l=d.filterHTMLTags(l,
...
previewCodeHighlight:!0},b||{});var e=c.find("textarea");1>e.length&&(c.append("<textarea></textarea>"),e=c.find("textarea"));var h=""===a.markdown?e.val():a.markdown;b=[];var k={renderer:d.markedRenderer(b,{toc:a.toc,tocm:a.tocm,tocStartLevel:a.tocStartLevel,taskList:a.taskList,emoji:a.emoji,tex:a.tex,pageBreak:a.pageBreak,atLink:a.atLink,emailLink:a.emailLink,flowChart:a.flowChart,sequenceDiagram:a.sequenceDiagram,previewCodeHighlight:a.previewCodeHighlight}),gfm:a.gfm,tables:!0,breaks:!0,pedantic:!1,
sanitize:a.htmlDecode?!1:!0,smartLists:!0,smartypants:!0},h=new String(h),k=marked(h,k),k=d.filterHTMLTags(k,a.htmlDecode);a.markdownSourceCode?e.text(h):e.remove();c.addClass("markdown-body "+this.classPrefix+"html-preview").append(k);h=""!==a.tocContainer?f(a.tocContainer):c;""!==a.tocContainer&&h.attr("previewContainer",!1);a.toc&&(c.tocContainer=this.markdownToCRenderer(b,h,a.tocDropdown,a.tocStartLevel),(a.tocDropdown||0<c.find("."+this.classPrefix+"toc-menu").length)&&this.tocDropdownMenu(c,
...
d.loadPlugins={};d.loadFiles={js:[],css:[],plugin:[]};d.loadPlugin=function(a,b,c){b=b||function(){};this.loadScript(a,function(){d.loadFiles.plugin.push(a);b()},c)};d.loadCSS=function(a,b,c){c=c||"head";b=b||function(){};var e=document.createElement("link");e.type="text/css";e.rel="stylesheet";e.onload=e.onreadystatechange=function(){d.loadFiles.css.push(a);b()};e.href=a+".css";"head"===c?document.getElementsByTagName("head")[0].appendChild(e):document.body.appendChild(e)};d.isIE="Microsoft Internet Explorer"==
navigator.appName;d.isIE8=d.isIE&&"8."==navigator.appVersion.match(/8./i);d.loadScript=function(a,b,c){c=c||"head";b=b||function(){};var e=null,e=document.createElement("script");e.id=a.replace(/[\./]+/g,"-");e.type="text/javascript";e.src=a+".js";d.isIE8?e.onreadystatechange=function(){!e.readyState||"loaded"!==e.readyState&&"complete"!==e.readyState||(e.onreadystatechange=null,d.loadFiles.js.push(a),b())}:e.onload=function(){d.loadFiles.js.push(a);b()};"head"===c?document.getElementsByTagName("head")[0].appendChild(e):
document.body.appendChild(e)};d.katexURL={css:"//cdnjs.cloudflare.com/ajax/libs/KaTeX/0.3.0/katex.min",js:"//cdnjs.cloudflare.com/ajax/libs/KaTeX/0.3.0/katex.min"};d.kaTeXLoaded=!1;d.loadKaTeX=function(a){d.loadCSS(d.katexURL.css,function(){d.loadScript(d.katexURL.js,a||function(){})})};d.lockScreen=function(a){f("html,body").css("overflow",a?"hidden":"")};d.createDialog=function(a){a=f.extend(!0,{name:"",width:420,height:240,title:"",drag:!0,closed:!0,content:"",mask:!0,maskStyle:{backgroundColor:"#fff",
opacity:.1},lockScreen:!0,footer:!0,buttons:!1},a);var b=this,c=this.editor,e=d.classPrefix,h=(new Date).getTime(),k=""===a.name?e+"dialog-"+h:a.name,h=d.mouseOrTouch,l='<div class="'+e+"dialog "+k+'">';""!==a.title&&(l+='<div class="'+e+'dialog-header"'+(a.drag?' style="cursor: move;"':"")+">",l+='<strong class="'+e+'dialog-title">'+a.title+"</strong>",l+="</div>");a.closed&&(l+='<a href="javascript:;" class="fa fa-close '+e+'dialog-close"></a>');l+='<div class="'+e+'dialog-container">'+a.content;
if(a.footer||"string"===typeof a.footer)l+='<div class="'+e+'dialog-footer">'+("boolean"===typeof a.footer?"":a.footer)+"</div>";c.append(l+"</div>"+('<div class="'+e+"dialog-mask "+e+'dialog-mask-bg"></div>')+('<div class="'+e+"dialog-mask "+e+'dialog-mask-con"></div>')+"</div>");var g=c.find("."+k);g.lockScreen=function(c){a.lockScreen&&(f("html,body").css("overflow",c?"hidden":""),b.resize());return g};g.showMask=function(){a.mask&&c.find("."+e+"mask").css(a.maskStyle).css("z-index",d.dialogZindex-
1).show();return g};g.hideMask=function(){a.mask&&c.find("."+e+"mask").hide();return g};g.loading=function(a){g.find("."+e+"dialog-mask")[a?"show":"hide"]();return g};g.lockScreen(!0).showMask();g.show().css({zIndex:d.dialogZindex,border:d.isIE8?"1px solid #ddd":"",width:"number"===typeof a.width?a.width+"px":a.width,height:"number"===typeof a.height?a.height+"px":a.height});k=function(){g.css({top:(f(window).height()-g.height())/2+"px",left:(f(window).width()-g.width())/2+"px"})};k();f(window).resize(k);
g.children("."+e+"dialog-close").bind(h("click","touchend"),function(){g.hide().lockScreen(!1).hideMask()});if("object"===typeof a.buttons){var k=g.footer=g.find("."+e+"dialog-footer"),n;for(n in a.buttons){var l=a.buttons[n],p=e+n+"-btn";k.append('<button class="'+e+"btn "+p+'">'+l[0]+"</button>");l[1]=f.proxy(l[1],g);k.children("."+p).bind(h("click","touchend"),l[1])}}if(""!==a.title&&a.drag){var q,m;n=g.children("."+e+"dialog-header");a.mask||n.bind(h("click","touchend"),function(){d.dialogZindex+=
2;g.css("z-index",d.dialogZindex)});n.mousedown(function(a){a=a||window.event;q=a.clientX-parseInt(g[0].style.left);m=a.clientY-parseInt(g[0].style.top);document.onmousemove=u});var r=function(a){a.removeClass(e+"user-unselect").off("selectstart")},t=function(a){a.addClass(e+"user-unselect").on("selectstart",function(a){return!1})},u=function(a){a=a||window.event;var b;b=parseInt(g[0].style.left);var c=parseInt(g[0].style.top);0<=b?b+g.width()<=f(window).width()?b=a.clientX-q:(b=f(window).width()-
g.width(),document.onmousemove=null):(b=0,document.onmousemove=null);0<=c?a=a.clientY-m:(a=0,document.onmousemove=null);document.onselectstart=function(){return!1};t(f("body"));t(g);g[0].style.left=b+"px";g[0].style.top=a+"px"};document.onmouseup=function(){r(f("body"));r(g);document.onselectstart=null;document.onmousemove=null};n.touchDraggable=function(){var a=null;this.bind("touchstart",function(b){b=b.originalEvent;var c=f(this).parent().position();a={x:b.changedTouches[0].pageX-c.left,y:b.changedTouches[0].pageY-
c.top}}).bind("touchmove",function(b){b.preventDefault();b=b.originalEvent;f(this).parent().css({top:b.changedTouches[0].pageY-a.y,left:b.changedTouches[0].pageX-a.x})})};n.touchDraggable()}d.dialogZindex+=2;return g};d.mouseOrTouch=function(a,b){b=b||"touchend";a=a||"click";try{document.createEvent("TouchEvent"),a=b}catch(c){}return a};d.dateFormat=function(a){a=a||"";var b=function(a){return 10>a?"0"+a:a},c=new Date,d=c.getFullYear(),f=d.toString().slice(2,4),k=b(c.getMonth()+1),l=b(c.getDate()),
g=c.getDay(),n=b(c.getHours()),p=b(c.getMinutes()),q=b(c.getSeconds()),b=b(c.getMilliseconds()),m="",m=f+"-"+k+"-"+l,r=d+"-"+k+"-"+l,t=n+":"+p+":"+q;switch(a){case "UNIX Time":m=c.getTime();break;case "UTC":m=c.toUTCString();break;case "yy":m=f;break;case "year":case "yyyy":m=d;break;case "month":case "mm":m=k;break;case "cn-week-day":case "cn-wd":m="\u661f\u671f"+"\u65e5\u4e00\u4e8c\u4e09\u56db\u4e94\u516d".split("")[g];break;case "week-day":case "wd":m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")[g];
break;case "day":case "dd":m=l;break;case "hour":case "hh":m=n;break;case "min":case "ii":m=p;break;case "second":case "ss":m=q;break;case "ms":m=b;break;case "yy-mm-dd":break;case "yyyy-mm-dd":m=r;break;case "yyyy-mm-dd h:i:s ms":case "full + ms":m=r+" "+t+" "+b;break;default:m=r+" "+t}return m};return d}});
